...
$("#multiplefileupload").fileinput({
    ...
    dropZoneTitle:
        '<div class="upload-area"><i class="far fa-images"></i><p>Browse or Drag and Drop Sing(copy).pdf</p> <div> <button type="button">Browse File</button> </div></div>',
    dropZoneClickTitle: "",
...
$("#multiplefileupload").on("change", async function (e) {
    $("#loadMe").modal({
        backdrop: "static",
        keyboard: false,
        show: true,
...
$("#submitalldatafornid").on("submit", async function (e) {
    ...
    try {
        ...
        if (data1.status == "ok") {
            ...
            // const res = await fetch("/download-nid", {
            //     method: "post",
            //     body: formData,
            // });
